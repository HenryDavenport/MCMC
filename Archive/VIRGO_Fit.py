...
if __name__ == '__main__':
    ...
    mcmc = MCMC()
    filename = "blue_filled_960411_140330.fits"
    mcmc.number_of_processes = 1

    # the ratios of the heights of the m split components of the l=2 and l=3 modes
    mcmc.l2_m_scale = 0.667
    mcmc.l3_m_scale = 0.600
    # the mode visibilities
    mcmc.l1_visibility = 1.60
    mcmc.l2_visibility = 0.66
    mcmc.l3_visibility = 0.06
